...
Public Class DVDArt_Common
    ...
    Public Shared Function getMovingPicturesImagePath(ByVal database As String, ByVal imdb_id As String, ByVal field As String) As String
    ...
    Public Shared Function import(ByVal database As String, ByVal thumbs As String, ByVal id As String, ByVal title As String, ByVal lang As String, ByVal type As String, ByVal personpath As String, ByVal checked As Array) As Array
        ...
        Log.Info("DVDArt: downloading artwork for " & type & " - """ & title & """")

        If type = "movie" Then

            Dim backdrop As String = getMovingPicturesImagePath(database, id, "backdrop")
            Dim cover As String = getMovingPicturesImagePath(database, id, "cover")
        ...
        If SQLcommand.CommandText <> Nothing Then
            ...
            Catch ex As Exception
                Log.Error("DVDArt: " & SQLcommand.CommandText & " failed with exception - " & ex.Message)
            End Try
        ...
        If downloaded.Contains(True) Then
            Log.Info("DVDArt: artwork found for: """ & title & """")
        Else
            Log.Info("DVDArt: no artwork found for: """ & title & """")
        End If
    ...
    Public Shared Function download(ByVal thumbs As String, ByVal folder(,,) As String, ByVal id As String, ByVal overwrite As Boolean, _
        ...
        Catch ex As Exception
            Log.Error("DVDArt: failed with exception - " & ex.Message)
        End Try
