...
Namespace DVDArt_Plugin

    <PluginIcons("DVDArt_Plugin.DVDArt_Plugin_enabled.png", "DVDArt_Plugin.DVDArt_Plugin_disabled.png")>
    Public Class DVDArt_Plugin
        Implements IPlugin
